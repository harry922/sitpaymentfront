...
/*
http://localhost:8080/PaymentSystem/api/addtransactionsbyid/1
http://192.168.0.37:8080/PaymentSystem/api/add-candidate
http://192.168.0.37:8080/PaymentSystem/api/candidates
http://192.168.0.37:8080/PaymentSystem/api/addtransactionsbyid/
http://localhost:8080/PaymentSystem/api/getCandidateById/2
http://localhost:8080/PaymentSystem/api/update-candidate
...
export class DataStorageService {
    ...
    postCandidate(candidate: Candidate) {
        ...
        return this.http.post('http://localhost:8080/PaymentSystem/api/add-candidate', candidate);
    }

    /* get candidates */
    getCandidates() {
        // return this.http.get('http://192.168.0.37:8080/api/candidates')
        return this.http.get('http://localhost:8080/PaymentSystem/api/candidates')
            .map(
    ...
    putCandidate(index: number, candidate: Candidate) {
        ...
        return this.http.put('http://localhost:8080/PaymentSystem/api/update-candidate', candidate);
    }
    ...
    postPvTransaction(id: number, pvDetail: Transaction) {
        ...
        return this.http.post('http://localhost:8080/PaymentSystem/api/addtransactionsbyid/' + id, pvDetail);
    }

    /* get PV and SV details*/
    getPvtransactions(id: number) {
        // return this.http.get('http://192.168.0.37:8080/api/gettransactions/' + id)
        return this.http.get('http://localhost:8080/PaymentSystem/api/gettransactions/' + id)
            .map(
            (response: Response) => {
    ...
    getRecentTransactions(candidateId: number) {
        ...
        return this.http.get('http://localhost:8080/PaymentSystem/api/getrecenttransactions/' + candidateId)
            .map(
            (response: Response) => {
    ...
    getPaidTransactions(candidateId: number) {
        ...
        return this.http.get('http://localhost:8080/PaymentSystem/api/paidtab/' + candidateId)
            .map(
            (response: Response) => {
    ...
    putTransaction(id: number, detail: any) {
        ...
        return this.http.put('http://localhost:8080/PaymentSystem/api/updatetransactions/' + id, detail);
    }

    /* post employees */
    postEmployee(employee) {
        // return this.http.post('http://192.168.0.37:8080/api/add-employee', employee);
        return this.http.post('http://localhost:8080/PaymentSystem/api/add-employee', employee);
    }

    /* get employees */
    getEmployees() {
        // return this.http.get('http://192.168.0.37:8080/api/employees')
        return this.http.get('http://localhost:8080/PaymentSystem/api/employees')
            .map(
